    ...
    var dataSource = new kendo.data.DataSource({
        ...
        schema: {
            model: {
                id: "ID_HoaDon",
                fields: {
                    ID_HoaDon: { type: "number", editable: false },
                    ...
                    ID_LichKham: { type: "number", editable: true },
                    NgayLap: { type: "date", editable: true },
                    GiaTriHoaDon: {
                        type: "number",
                        //validation: { required: true },
                        //nullable: false
    ...
    var grid = $("#grid").kendoGrid({
        ...
        columns:
...

           {
            ...
            {
                field: "TienThuoc", title: "Tiền thuốc", width: "124px",
                headerAttributes: {
                    "class": "table-header-cell",
                    style: "text-align: left; font-size: 14px;vertical-align: middle"
                },
            ...
            {
                field: "TienKhamBenh", title: "tiền khám bệnh", width: "116px",
                headerAttributes: {
                    "class": "table-header-cell",
                    style: "text-align: left; font-size: 14px;vertical-align: middle"
                },
            ...
            {
                field: "NgayLap", title: "Ngày lập", width: "272px",
                //filterable:
                //    {
                //        ui: CanHo_Filter
                //    },
