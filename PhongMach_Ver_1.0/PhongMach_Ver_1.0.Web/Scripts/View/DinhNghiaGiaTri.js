angular.module('KendoDemos', ["kendo.directives", "ui-notification"]).controller("MyCtrl", function ($scope, Notification) {
    ...
    $("#grid").delegate(".k-grid-sua", "click", function (e) {
        ...
        $scope.itemAdd.tenDinhNghia = param.tenDinhNghia;
    ...
    $("#grid").delegate(".k-grid-xoa", "click", function (e) {
        ...
        $("#yesButton").click(function () {
            if ($(this).hasClass("delete-confirm")) {
                $.ajax({
                    url: '/DinhNghiaGiaTri/Delete',
                    type: "post",
                    data: JSON.stringify({ id: item.ID_DinhNghiaGiaTri }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (response) {
                        if (response.StatusCode == 200) {
    ...
    var dataSource = new kendo.data.DataSource({
        ...
        schema: {
            model: {
                id: "ID_DinhNghiaGiaTri",
                fields: {
                    ID_DinhNghiaGiaTri: { type: "number", editable: false },
                    ...
                    //Date_Edited:{type:"datetime",editable:false},
                }
            },
        },
        //data: "rows",
   ...
   // var record = 0;
    var grid = $("#grid").kendoGrid({
        ...
        resizable: true,
        height: 525,
        toolbar: [{ name: "create" ,text:"Dữ liệu mới"}],
        editable:"inline",
        // pageable: true,
        ...
        columns:
...

           {
            ...
            {
                field: "tenDinhNghia", title: "Tên Định Nghĩa", width: "257px",
                locked: true,
                lockable: false,
